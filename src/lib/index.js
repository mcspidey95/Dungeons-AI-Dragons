...
export let avatarGenerationPrompt = `Given a character name and description, generate a highly detailed prompt for a Stable Diffusion model to create a **portrait** of the character. 
